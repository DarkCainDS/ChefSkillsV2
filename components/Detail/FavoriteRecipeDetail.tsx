// screens/FavoriteRecipeDetail.tsx
...
// ✅ Importación de useRoute para un manejo estándar de las props de navegación
...
// ✅ CORRECCIÓN: Se mantiene el nombre original del componente (FavoriteRecipeDetail)
export default function FavoriteRecipeDetail() {
  
  // ✅ CORRECCIÓN DE NAVEGACIÓN: Se usa useRoute para obtener el objeto recipe
  const route = useRoute<RouteProp<RootStackParamList, 'FavoriteRecipeDetail'>>();
  ...
  // Nota: Se eliminó `isListVisible` del state ya que no se usa tras simplificar la lógica del multiplicador
