...
// ✅ Importación de React Navigation para usar useRoute
...
type RootStackParamList = {
    DrinkRecipeDetail: { recipe: Recipe };
};

// ✅ CORRECCIÓN 1: Se elimina { recipe } de las props y se usa useRoute
export default function DrinkRecipeDetail() {
  
  // ✅ CORRECCIÓN 2: Se usa useRoute para obtener el objeto recipe
  const route = useRoute<RouteProp<RootStackParamList, 'DrinkRecipeDetail'>>();
