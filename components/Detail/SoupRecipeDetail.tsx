...
// ✅ CORREGIDO: Animated ha sido removido de la importación de 'react'
...
import {
  ...
  View,
  Alert,
  // ✅ CORREGIDO: Animated se importa correctamente de 'react-native'
  Animated, 
} from 'react-native';
...
export default function SoupRecipeDetail({ route }: Props) {
