// screens/SaladRecipeListMain.tsx
...
function SaladRecipeListMain() {
  const navigation = useNavigation();
  const [recipes] = useState(saladsData.recipes);
  ...
  const renderRecipe = useCallback(
    ({ item }) => (
      <TouchableOpacity
        ...
        activeOpacity={0.8}
        onPress={() =>
          navigation.navigate("SaladRecipeDetail", { recipe: item })
        }
      >
        <Image
...
// 🧠 Optimización global
export default React.memo(SaladRecipeListMain);
