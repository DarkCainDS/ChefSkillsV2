// screens/SoupRecipeListMain.tsx
...
import soupsData from "../../assets/Json/Soup.json";

// 🟢 Util estándar para imágenes seguras
...
// 🌀 Mezclador para variación visual
...
function SoupRecipeListMain() {
  const navigation = useNavigation();
  const [recipes] = useState(soupsData.recipes);
  ...
  // 🎲 Barajar resultados para que no se vean repetitivos
  ...
  const renderRecipe = useCallback(
    ({ item }) => (
      <TouchableOpacity
        ...
        activeOpacity={0.8}
        onPress={() =>
          navigation.navigate("SoupRecipeDetail", { recipe: item })
        }
      >
        <Image
...
export default React.memo(SoupRecipeListMain);
